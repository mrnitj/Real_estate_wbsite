      ...
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          <Form className="d-flex" style={{gap:'2rem'}}>
            <Button variant="outline-secondary" style={{width:'100px', height:'48px', fontSize:'14px', fontWeight:'400'}}>LOGIN</Button>
            <Button variant="outline-secondary" style={{width:'142px', height:'48px', fontSize:'14px', fontWeight:'400'}}>GET STARTED</Button>
          </Form>
        </Navbar.Collapse>
      </Container>
    </Navbar>
